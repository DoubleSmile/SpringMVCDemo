...
public class RedirectController {
	...
	public String uriTemplate(RedirectAttributes redirectAttrs) {
		...
		redirectAttrs.addAttribute("date", new Date(2011, 12, 31));  // Appended as a query parameter
	...
	public String uriComponentsBuilder() {
		String date = this.conversionService.convert(new Date(2011, 12, 31), String.class);
